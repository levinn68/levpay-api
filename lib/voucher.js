...
// ✅ deviceKey unlimited (bypass limit bulanan)
...
// ✅ FINAL: monthly tidak otomatis + tidak stack default
function applyDiscount({
  ...
  // ✅ default OFF: monthly gak otomatis kepake
  useMonthly = false,

  // ✅ default false: monthly gak stack sama voucher
  ...
  // ✅ monthly cuma kalau diminta + deviceKey ada
  const canMonthly =
    !!useMonthly &&
    !!deviceKey &&
    (!v.ok || stackWithVoucher);
