// api/paidlog.js  (SAFE BOOT)
let createClient = null;
let SUPA_IMPORT_ERR = null;
...
const SUPABASE_SERVICE_KEY = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImFnd2F4YWVqbm5zenVuY2NtZnRtIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NjYwMjI0NDUsImV4cCI6MjA4MTU5ODQ0NX0.fB_-VKL6CyjYa3jaG_6Pmag-Za-DEQhRujSiEmk1l-I"; // hardcode (risk)
...
module.exports = async function handler(req, res) {
  try {
    ...
    // ✅ ping: ngecek function bisa jalan TANPA supabase
    ...
    // kalau module supabase gagal kebaca → kasih error jelas (bukan crash)
    if (!createClient) {
      return json(res, 500, {
        success: false,
        error: "SUPABASE_MODULE_NOT_FOUND_OR_IMPORT_FAILED",
        detail: String(SUPA_IMPORT_ERR?.message || SUPA_IMPORT_ERR || "unknown"),
        hint:
          "Fix: tambahin dependency @supabase/supabase-js di package.json lalu npm i + redeploy. Pastikan ga ada type:module (atau pakai versi ESM).",
      });
    }

    // init client baru setelah pasti ada module
